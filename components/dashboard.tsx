import { ArrowUpDown, Grid, List, Search, X } from "lucide-react";
    ...
    <div className="mx-auto max-w-7xl px-4 pb-12">
      ...
      {displayedUsers.length > 0 ? (
        <div className="mt-8 text-center">
          <button
            className="rounded-full border border-gray-300 bg-white px-8 py-2 font-medium text-gray-700 text-sm shadow-sm transition-colors hover:bg-gray-50"
            type="button"
          >
            Load More Results
          </button>
