...
URL Source: https://www.couchsurfing.com/about/jobs/rails.html
...
As our Full Stack Engineer, you will work closely with the Front-End, Back-End, and Mobile engineers to make our site and apps something that reflects the awesome experiences our users create in the real world. Our current stack includes Ruby on Rails, Javascript, SCSS, MySQL, SOLR, Redis, and Thumbor but we believe in using the right tool for the job and that great engineers with relevant experience can learn quickly.

Experience and skills we’re interested in
-----------------------------------------

* At least two years working on consumer websites using Rails in a team environment
...
[Apply for this position here](https://couchsurfing.recruiterbox.com/jobs/fk085f)
