...
As VP of Product, you’ll play an integral role in building out Couchsurfing’s vision for revolutionizing the ways that travelers connect around the world. You’ll be responsible for the product from strategy to execution, working with designers, engineers, the founders, user ops, sales, marketing, and other PMs to help build the best product possible.
...
* Manage communication across stakeholders company-wide
* Define product metrics and analyze results
...
* Experience in working on a marketplace product is ideal
...
[Apply for this position here](https://couchsurfing.recruiterbox.com/jobs/fk0hlnq)
