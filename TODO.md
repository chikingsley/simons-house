...
### Core Features
- [ ] Implement reference submission system
  - [ ] "Write Reference" button on other users' profiles
  - [ ] Reference type selector (Host/Surfer/Personal)
